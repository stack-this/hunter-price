 ...
 */
class Store extends \HunterBundle\Entity\Store implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'HunterBundle\\Entity\\Store' . "\0" . 'id', '' . "\0" . 'HunterBundle\\Entity\\Store' . "\0" . 'location', '' . "\0" . 'HunterBundle\\Entity\\Store' . "\0" . 'address', '' . "\0" . 'HunterBundle\\Entity\\Store' . "\0" . 'phone', '' . "\0" . 'HunterBundle\\Entity\\Store' . "\0" . 'product'];
        }
